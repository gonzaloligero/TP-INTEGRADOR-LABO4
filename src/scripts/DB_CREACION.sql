...
VALUES (CURDATE(), 'Pago de servicios', 150.75, 123456789, 987654321, 4);

INSERT INTO MOVIMIENTOS (Fecha, Detalle, Importe, IDCuentaEmisor, IDCuentaReceptor, IDTipoMovimiento)
VALUES (CURDATE(), 'Transferencia bancaria', 300.50, 789123456, 246810123, 4);
...
VALUES (11111111, 1, '2024-06-28', 123456789, '1234567801234567890104', 10000.00,1);
INSERT INTO CUENTAS (DNICliente, IDTipoCuenta, FechaCreacion, NumeroCuenta, CBU, Saldo,ESTADO)
VALUES (11111111, 2, '2024-06-28', 987654321, '1234567801234567890106', 10000.00,1);
