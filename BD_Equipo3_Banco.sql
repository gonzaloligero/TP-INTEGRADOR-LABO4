...
INSERT INTO USUARIOS (Usuario, Contraseña, TipoUsuario, Estado) VALUES ('admin', '123', 1, 1);
...
INSERT INTO TELEFONOS (DNICliente, NumeroTelefonico) VALUES (44444444, '1122445648');
...
INSERT INTO TIPO_PRESTAMOS (Tipo, TNA) VALUES ('Hipotecario TNA 5%', 5);
INSERT INTO TIPO_PRESTAMOS (Tipo, TNA) VALUES ('Automotriz TNA 10%', 10);
INSERT INTO TIPO_PRESTAMOS (Tipo, TNA) VALUES ('Estudiantil TNA 15%', 15);
INSERT INTO TIPO_PRESTAMOS (Tipo, TNA) VALUES ('Comercial TNA 20%', 20);
INSERT INTO TIPO_PRESTAMOS (Tipo, TNA) VALUES ('Agrícola TNA 18%', 18);
...
VALUES (11111111, '2024-06-28', 123456789, '71190104', 10000.00,1, TRUE);
INSERT INTO CUENTAS (DNICliente, FechaCreacion, NumeroCuenta, CBU, Saldo,IDTipoCuenta, ESTADO)
VALUES (22222222, '2024-06-28', 987654321, '23000987', 5000.00, 1, TRUE);
INSERT INTO CUENTAS (DNICliente, FechaCreacion, NumeroCuenta, CBU, Saldo,IDTipoCuenta, ESTADO)
VALUES (44444444, '2024-06-28', 246810123, '11230108', 15000.00, 1, TRUE);
INSERT INTO CUENTAS (DNICliente, FechaCreacion, NumeroCuenta, CBU, Saldo, IDTipoCuenta, ESTADO) 
VALUES (10101010, CURDATE(), 55447628, '97739201', 1800000.00, 1, TRUE);
...
BEGIN
    ...
    IF OLD.Estado = 0 AND NEW.Estado = 1 THEN
        ...
        BEGIN
            ...
            INSERT INTO MOVIMIENTOS (Fecha, Detalle, Importe, IDCuentaEmisor, IDCuentaReceptor, IDTipoMovimiento) 
            VALUES (NEW.Fecha, CONCAT('Préstamo aprobado - ID: ', NEW.IDPrestamo), NEW.MontoPedido, 11111111, 
                    (SELECT NumeroCuenta FROM CUENTAS WHERE DNICliente = NEW.DNICliente AND IDTipoCuenta = 1), 
                    2);
        END;
    END IF;
END;
