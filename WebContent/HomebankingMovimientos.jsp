...
<body>
			...
			<div class="sidebar-collapse collapse">
				<ul class="nav" id="main-menu">
					<li class="active-link"><a
						href="ServletMovimientos?action=listaMovimientos"><i
							class="fa fa-history"></i>Historial de Movimientos</a></li>
					...
					<li><a href="ServLetPrestamos?action=PagarPrestamo"><i
							class="fa fa-qrcode"></i>Pago de Préstamos</a></li>
					<li><a href="HomebankingInfomacionPersonal.jsp"><i
							class="fa fa-bar-chart-o"></i>Información Personal</a></li>
				</ul>
			</div>
		</nav>
		<!-- /. NAV SIDE  -->
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="container mt-4">
					<form action="ServletMovimientos" method="get" class="form-inline">
						...
						<input type="hidden" name="action" value="buscarPorTM">
					</form>
				</div>
					...
					<table class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><%=item.getIdCuentaEmisor()%></td>
								<td><%=item.getIdCuentaReceptor()%></td>
	...
	<div class="LOGEARSE">
		...
		<p>
			No has iniciado sesión. <a href="Login.jsp">Inicia sesión aquí</a>.
		</p>
	</div>
	<%
		}
